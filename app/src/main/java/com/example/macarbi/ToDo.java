...
public class ToDo extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private NotificationManagerCompat notificationManager;//push
    Button btn;
    EditText et1;
    EditText et2;
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notificationManager = NotificationManagerCompat.from(this);//push
        if (user != null) {
                ...
                AlertDialog dialog = new AlertDialog.Builder(ToDo.this)
                        ...
                        .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(ToDo.this, "" +child + " deleted", Toast.LENGTH_LONG).show();
